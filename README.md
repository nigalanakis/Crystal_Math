...
Due to its specific installation instructions and licensing, refer to the official [https://downloads.ccdc.cam.ac.uk/documentation/API/installation_notes.html](https://downloads.ccdc.cam.ac.uk/documentation/API/installation_notes.html) page for detailed guidance. 
